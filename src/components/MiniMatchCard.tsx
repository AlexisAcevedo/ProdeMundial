...
export function MiniMatchCard({ match, prediction, onSubmit }: { match: Match, prediction?: Prediction, onSubmit: (matchId: string, home: number, away: number) => Promise<void> }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between rounded-xl glass-card p-3 hover:shadow-md transition-shadow dark:border-white/5 gap-3">
      {/* Time & Status */}
